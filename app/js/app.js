...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxareaComponentsNumberJs = __webpack_require__(181);

	var _reduxareaComponentsNumberJs2 = _interopRequireDefault(_reduxareaComponentsNumberJs);

	var _reduxareaActionsNumericOperationJs = __webpack_require__(182);

	var _reduxareaStoresAppStoreJs = __webpack_require__(184);

	var _reduxareaStoresAppStoreJs2 = _interopRequireDefault(_reduxareaStoresAppStoreJs);
	...
	var App = (function (_Component) {
		...
		_createClass(App, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(_reduxareaComponentsNumberJs2['default'], { score: this.props.score, inc: this.props.inc, dec: this.props.dec });
			}
		}]);
	...
	function connectDispatch(dispatch) {
		return {
			inc: function inc() {
				...
				dispatch((0, _reduxareaActionsNumericOperationJs.increment)(1));
			},
			dec: function dec() {
				dispatch((0, _reduxareaActionsNumericOperationJs.decrement)());
			}
		};
	}

	App = (0, _reactRedux.connect)(connectStore, connectDispatch)(App);

	var Root = function Root() {
		return _react2['default'].createElement(
			_reactRedux.Provider,
			{ store: _reduxareaStoresAppStoreJs2['default'] },
			...
			value: function render() {
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(
							"button",
							{ type: "button", className: "btn btn-default", onClick: this.props.inc },
							"Increment"
						),
						_react2["default"].createElement(
							"button",
							{ type: "button", className: "btn btn-default", onClick: this.props.dec },
							"Decrement"
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _constantsAppconstant = __webpack_require__(183);

	var type = _interopRequireWildcard(_constantsAppconstant);
...
/***/ function(module, exports) {
	...
	var INCREMENT = 'Increment number';
	exports.INCREMENT = INCREMENT;
	var DECREMENT = 'Decrement number';
	exports.DECREMENT = DECREMENT;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducersAppReducers = __webpack_require__(185);

	var _reducersAppReducers2 = _interopRequireDefault(_reducersAppReducers);

	var initialState = {
	    number: 0
	};

	exports['default'] = (0, _redux.createStore)(_reducersAppReducers2['default'], initialState);
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _numberReducerJs = __webpack_require__(186);

	var _redux = __webpack_require__(165);

	var numberApp = (0, _redux.combineReducers)({
	  number: _numberReducerJs.number
	});

	exports['default'] = numberApp;
	module.exports = exports['default'];
